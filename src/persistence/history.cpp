...
QVector<RawDatabase::Query>
generateNewSystemMessageQueries(const ToxPk& friendPk, const QDateTime& time,
    const SystemMessage& systemMessage)
{
    ...
    std::transform(systemMessage.args.begin(), systemMessage.args.end(), std::back_inserter(blobs), [] (const QString& s) {
        return s.toUtf8();
    });

    queries += RawDatabase::Query(
        QString("INSERT INTO system_messages (id, message_type, system_message_type, arg1, arg2, arg3, arg4)"
